  ...
  render(){
    return(
      <section className="home">
        ...
        <p>
            I'm currently looking to join a team of passionate developers where I can continue to learn and grow as a developer. If you're looking to add a curious, driven developer to your team, feel free to check out my work below and reach out if you see something you like.
        </p>
        <div>
